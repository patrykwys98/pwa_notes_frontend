...
const GetInfoAboutSharedNote = ({ open, noteId, handleClose }) => {

  const axios = useAxios()
  const [infoAboutSharedNote, setInfoAboutSharedNote] = useState([])
      ...
      <DialogContent>
        {editShare ? (<>
          <FormGroup>
            ...
            />
            <FormControlLabel
              control={<Checkbox checked={canView} onChange={(e) => setCanView(e.target.checked)} />}
              label="Can view"
            />
            <FormControlLabel
              control={<Checkbox checked={canDelete} onChange={(e) => setCanDelete(e.target.checked)} />}
              label="Can delete"
            />
            <FormControlLabel
              control={<Checkbox checked={canShare} onChange={(e) => setCanShare(e.target.checked)} />}
              label="Can share"
            />
          </FormGroup>
